...
Seeded-defect benchmark suite comparing BASELINE / DIVERGENT / AUTISTIC /
DIVERGENT→AUTISTIC. See [`../EVALS.md`](../EVALS.md) for results and
...
to test the DIVERGENT→AUTISTIC combined condition on the problem type it's
