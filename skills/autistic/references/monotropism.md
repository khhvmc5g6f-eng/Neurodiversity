...
the next-ranked one. This is symmetric with ADHD's anti-pattern of
"convergence disguised as divergence" — here the matching failure is
"depth disguised as progress."
